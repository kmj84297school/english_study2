...
window.EXAM_DATA["vocabulary"] = [
  {
    ...
    "compare": [
      [
        ...
        "different responses",
        "행위 동일·조건과 목적 다름",
        "친구 관계 유지와 공식 경기 승리라는 목표가 다르다. 저자가 고정 윤리의 관점에서 두 행동을 모두 옳다고 선언한 것이 아니다."
      ]
    ],
    "refs": [
      [
      ...
      [
        7,
        "the same",
        "친선 경기에서 인정하던 것과 동일한 반칙"
      ]
    ],
    "syntax": [
      [
        3,
        "주어 what matters → 동사 is → 보어 the outcome or consequences. what절은 중요한 것이 무엇인지 한 단위로 만든다."
      ],
      [
        8,
        "to abandon(수정 gain)은 목적의 to부정사. get away with는 잘못을 하고도 처벌을 면한다는 뜻이다."
      ]
    ],
    "central": "스포츠의 상황 윤리는 관계 유지나 승리처럼 상황별 목적에 따라 같은 행위에 대한 판단과 행동을 달리하게 한다.",
    "tip": "설명 대상인 상황 윤리와 필자의 개인적 도덕 권고를 혼동하지 말자.",
    "topicEN": "Context-dependent ethical choices in sports",
    "titleEN": "Same Foul, Different Goals",
    "order": [
      [
        1,
        4,
    ...
    "insert": [
      7,
      "the same fouls가 S5를 받고 But이 S6의 친구 배려와 승리 목적을 대비한다."
    ],
    "blank": [
      3,
      "the end justifies the means",
      "두 경기에서 서로 다른 목적이 행동을 결정한다."
    ],
    "vocab": [
      [
        "absolute",
      ...
      [
        "abandon → gain",
        "포기하다 → 얻다",
        "승리가 목적이므로 경쟁 이익을 버리는 방향은 반대"
      ]
    ],
    "answer": "⑤ abandon → gain 또는 secure. 승리를 위해 이익을 확보한다는 문맥이다.",
    "edits": [
      [
        8,
        "abandon",
        "gain",
        "승리라는 목적과 경쟁 우위 획득의 방향 일치"
      ]
    ],
    "turns": [
      7
  ...
  },
  {
    ...
    "compare": [
      [
        "undesirable to hard-path",
        "ecologically important to soft-path",
        "평가 주체와 기준",
        "같은 습지·갈래 물길을 계획 수행의 장애물로 보느냐 생태적 기능으로 보느냐가 다르다."
      ],
      [
        "footpath",
        "river engineering",
        "비유 사례 vs 중심 주제",
        "오솔길 자체의 개발법이 아니라 자연 변화에 대한 공학의 태도가 상위 개념이다."
      ]
    ],
    "refs": [
      [
        2,
        "its / it",
        "soft-path river engineering / 그 접근법"
      ],
      [
        6,
        "it",
    ...
    "syntax": [
      [
        10,
        "주어 Backwaters…swamps → 동사 are presumed → 보어 to be important. all undesirable…는 삽입구이며 다른 접근법의 평가를 끼워 넣는다."
      ]
    ],
    "central": "소프트 패스 하천 공학은 인간 지식의 한계를 인정하고 자연의 변동성과 다양한 생태 요소를 존중한다.",
    "tip": "‘개입하지 않음’은 무관심이 아니라 중요성을 함부로 부정하지 않는 지적 겸손이다.",
    "topicEN": "Ecological respect and intellectual modesty in soft-path engineering",
    "titleEN": "Work with the River, Not Against It",
    "order": [
      [
        1,
        4,
    ...
    "insert": [
      8,
      "길 비유를 마친 뒤 river movement로 중심 주제로 돌아가 S9–10의 가치 평가를 준비한다."
    ],
    "blank": [
      8,
      "intellectual modesty",
      "자연의 변화를 일단 중요하게 인정한다는 뒤 설명을 포괄한다."
    ],
    "vocab": [
      [
        "interventionist",
      ...
      [
        ...
        "중요하지 않은 → 중요한",
        "뒤 ecologically important와 일치 필요"
      ]
    ],
    "answer": "⑤ insignificant → significant. 자연의 변동성과 생태 요소를 중요하게 여기는 관점이다.",
    "edits": [
      [
        9,
        "insignificant",
        "significant",
        "마지막 문장의 ecologically important가 근거"
      ]
    ],
    "turns": [
      8,
  ...
  },
  {
    ...
    "compare": [
      [
        ...
        "similar practices",
        "자각·느낌 vs 실제 활동",
        "낯설다고 느끼는 것과 이미 유사한 활동을 하는 것은 양립한다."
      ],
      [
        "entrepreneurial brand",
        "scholarly voice",
        "비유의 하위 사례 vs 공통 원리",
        "제품 판매가 학자의 목적이라는 뜻이 아니라 구별되고 기억되는 원리를 빌린다."
      ]
    ],
    "refs": [
      [
      ...
      [
        7,
        "It",
        "아이디어 표현과 고유 목소리를 결합하는 글쓰기 과제"
      ]
    ],
    "syntax": [
      [
        6,
        "주어 The challenge → 동사 is → not just in developing…but in cultivating…. as Labaree suggests는 삽입구, that makes…는 voice를 수식한다."
      ]
    ],
    "central": "학술 글쓰기는 독창적인 아이디어와 독자가 알아보고 기억할 고유한 목소리를 함께 발전시켜야 한다.",
    "tip": "브랜딩은 학술 글쓰기의 차별화와 기억 가능성을 설명하는 비유이며 중심 주제는 제품 판매가 아니다.",
    "topicEN": "A distinctive, memorable voice in academic writing",
    "titleEN": "Ideas Need a Voice Readers Remember",
    "order": [
      [
        1,
        3,
    ...
    "insert": [
      4,
      "these entrepreneurial concepts가 S2–3을 받고 S5의 학술 사례로 다리를 놓는다."
    ],
    "blank": [
      6,
      "a distinctive voice",
      "혁신적 아이디어와 구별되는 표현 정체성이 필요하다."
    ],
    "vocab": [
      [
        "resonate",
    ...
    "answer": "⑤ temporary → lasting. 독자가 저자를 알아보고 기억해야 하므로 일시적 인상이 아니다.",
    "edits": [
      [
        7,
        "temporary",
        "lasting",
        "memorable·recognizable·distinctive가 반복되는 문맥"
      ]
    ],
    "turns": [
      4,
  ...
  },
  {
    ...
    "compare": [
      [
        "guilt generally associated with high motivation",
        "competitive motivation weakened",
        "일반 경향 vs 현재의 경쟁 조건",
        "죄책감이 대체로 동기를 자극할 수 있어도 상대를 이기는 일이 관계를 해치는 상황에서는 경쟁 목표 추구를 약화시킨다."
      ],
      [
        "upward comparison target",
        "person making comparison",
        "비교당하는 우수자 vs 비교하는 타인",
        "불편함을 느끼는 주체는 자신보다 우수한 사람을 질투하는 패자가 아니라 타인의 부러움을 받는 사람이다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        6,
        "Feelings of guilt가 주어, lead가 동사. an emotion…은 guilt의 일반 특성을 설명하는 동격 삽입구라 현재 문맥의 결과를 대신 결정하지 않는다."
      ]
    ],
    "central": "관계 유지가 중요한 경쟁에서는 타인의 부러움과 죄책감이 승자의 경쟁 동기를 낮추고 협력적 결과를 선호하게 할 수 있다.",
    "tip": "일반적인 죄책감 효과와 이 글의 경쟁·관계 갈등 조건을 분리해야 stronger의 오류가 보인다.",
    "topicEN": "Relational concerns as a source of reduced competitive motivation",
    "titleEN": "When Winning Feels Uncomfortable",
    "order": [
      [
        1,
        3,
    ...
    "insert": [
      4,
      "관계 갈등을 설명한 뒤 실제 연구로 승자의 불편함을 뒷받침하고 S5가 감정을 풀어 쓴다."
    ],
    "blank": [
      2,
      "maintain good relationships with others",
      "개인 목표 달성과 충돌하는 다른 동기가 관계 유지다."
    ],
    "vocab": [
      [
        "incentive",
      ...
      [
        "stronger → weaker",
        "더 강한 → 더 약한",
        "lower motivation과 일치"
      ]
    ],
    "answer": "④ stronger → weaker. 앞의 동기 저하와 뒤의 lower task motivation을 잇는다.",
    "edits": [
      [
        6,
        "stronger",
        "weaker",
        "경쟁 맥락에서의 동기 저하가 앞뒤 근거"
      ]
    ],
    "turns": [
      3,
  ...
  },
  {
    ...
    "compare": [
      [
        ...
        "irrational(S3)",
        "자기 믿음 vs 필자의 진단",
        "S1은 사실 확정이 아니라 like to think라는 자기 인식이다."
      ],
      [
        "less subject to errors",
        "more rational",
        "원인 인식 vs 개선 결과",
        "내재된 비합리성을 이해해서 합리성이 커진다. 합리성이 이미 완벽하다는 주장이 아니다."
      ]
    ],
    "refs": [
      [
      ...
      [
        5,
        "that",
        "인상 내용의 접속사로 지시대명사가 아니다."
      ],
      [
        8,
        "our mental processes",
        "S4–6에서 설명한 자동 사고와 편향을 포함한 사고 과정"
      ]
    ],
    "syntax": [
      [
        7,
        "주어 Understanding…(동명사구) → 동사 can make → 목적어 us → 병렬 보어 less subject / more rational / more aware. how절 두 개는 이해할 내용이다."
      ]
    ],
    "central": "우리의 자동 사고와 편향에 내재한 비합리성을 이해하면 자신의 판단과 타인에게 정보를 전달하는 능력을 개선할 수 있다.",
    "tip": "처음의 합리성은 믿음이고 마지막에 필요한 이해 대상은 실제의 비합리성이다.",
    "topicEN": "Improving reasoning and communication by understanding cognitive irrationality",
    "titleEN": "Know Your Biases to Think Better",
    "order": [
      [
        1,
        3,
    ...
    "insert": [
      7,
      "편향의 방해 작용을 충분히 설명한 뒤 그 작동 이해가 개선으로 이어진다고 전환한다."
    ],
    "blank": [
      7,
      "less subject to fallacious reasoning",
      "문제 인식의 결과는 오류 증가가 아니라 감소다."
    ],
    "vocab": [
      [
        "reflexive",
    ...
    "answer": "⑤ rationality → irrationality. 글이 이해하라고 하는 내재 특성은 자동 사고·편향의 비합리성이다.",
    "edits": [
      [
        8,
        "built-in rationality",
        "built-in irrationality",
        "S3–6의 실제 사고 특성을 받아야 함"
      ]
    ],
    "turns": [
      3
  ...
  },
  {
    ...
    "flow": [
      ...
      [
        ...
        4,
        5,
        "스스로 가치 있게 여기는 것과 다르다."
      ],
      [
        "숙제 사례",
        6,
        7,
        "외부 통제가 있을 때만 수행하는 모습을 보여준다."
      ],
      [
        "이유와 공감의 대안",
        8,
    ...
    "connectors": [
      [
        ...
        "This is not to say",
        "통제가 내면화를 막는다.",
        "통제의 행동 유발 효과까지 부정하지 않음"
      ],
      [
        4,
        "rather",
        "통제가 전혀 작동 안 한다는 오해",
        "작동하되 외부 의존을 만든다는 정확한 설명"
      ],
      [
        5,
        "Consequently / but instead",
        "외부 조절",
        "가치 형성 대신 통제 의존"
      ],
      [
    ...
    "compare": [
      [
        ...
        "internalization",
        "행동 발생 vs 가치의 자율적 수용",
        "통제는 숙제를 하게 만들 수 있지만 통제 없이도 스스로 가치 있게 여기게 하는 것은 별개다."
      ],
      [
        "introjected",
        "autonomous",
        "내부 압박 vs 자율적 동의",
        "압력을 마음속에 들였다는 사실만으로 완전한 자율적 내면화가 된 것은 아니다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        4,
        "the more + 형용사…, the more…는 비례 비교. 외부 통제가 두드러질수록 압력 의존이 커진다."
      ],
      [
        8,
        "who supply / show / use 세 동사는 parents를 수식하는 병렬 관계절. 주절은 parents are more likely…."
      ]
    ],
    "central": "외적 통제는 행동을 유발해도 자율적인 가치 내면화를 보장하지 않으며, 이유와 공감을 제공하는 지원이 자발성을 기른다.",
    "tip": "통제가 효과 있다는 S3과 해롭다는 S2는 각각 행동 발생과 가치 내면화라는 다른 결과를 말한다.",
    "topicEN": "Autonomy support rather than external control for internalization",
    "titleEN": "Compliance Is Not Internalization",
    "order": [
      [
        1,
        3,
    ...
    "insert": [
      3,
      "S2의 least likely 뒤에서 통제 효과 전체를 부정하는 오해를 막아야 rather의 정확한 설명이 이어진다."
    ],
    "blank": [
      5,
      "remains dependent on external controls",
      "숙제를 보상·강요 때만 하는 다음 사례가 이를 입증한다."
    ],
    "vocab": [
      [
        "internalization",
      ...
      [
        "drives → hinders",
        "촉진한다 → 방해한다",
        "자기 책임감과 외부 의존은 반대 방향"
      ]
    ],
    "answer": "④ drives → hinders 또는 impedes. 외부 통제 의존은 자기 책임감 획득을 방해한다.",
    "edits": [
      [
        7,
        "drives",
        "hinders",
        "외부 의존이라는 앞의 결과에 맞춘 동사"
      ]
    ],
    "turns": [
      3,
  ...
  },
  {
    ...
    "flow": [
      ...
      [
        ...
        4,
        5,
        "어떤 지식을 공유하는지 사례로 설명한다."
      ],
      [
        "가격 요구 조절",
        6,
        6,
        "필수성이 낮으면 과도한 요구를 피한다."
      ],
      [
        "가격 합의",
        7,
    ...
    "compare": [
      [
        "flexible prices",
        "enduring culture",
        "변하는 가격 vs 안정적인 사회적 기반",
        "가격 수준은 유연하게 조정돼도 그 조정의 전제인 상호 문화 이해는 지속될 수 있다."
      ],
      [
        "video games",
        "food",
        "같은 상품 범주 안의 필요성 차이",
        "구매 가능한 상품이라는 점은 같지만 생존 필수성은 다르므로 가격 수용성이 다르다."
      ]
    ],
    "refs": [
      [
      ...
      [
        ...
        "상대의 재정 제약·필요·선호에 대한 지식"
      ]
    ],
    "syntax": [
      [
        6,
        "because at no point will the buyer see…: 부정어구 at no point가 앞으로 나와 조동사 will과 주어가 도치된다."
      ]
    ],
    "central": "시장의 가격 합의는 구매자와 판매자가 공유 문화 속에서 상대의 재정 제약과 필요를 이해하는 데 기반한다.",
    "tip": "값을 낮추는 것 자체가 핵심이 아니라 상대의 구매 필요와 한계를 고려해 과도한 요구를 피하는 것이다.",
    "topicEN": "Shared cultural knowledge as a basis for price agreement in bazaars",
    "titleEN": "The Shared Understanding Behind a Bargain",
    "order": [
      [
        1,
        2,
    ...
    "insert": [
      5,
      "S4의 necessity/luxury 구분을 구체화해야 S6의 So가 가격 행동의 결과를 이끈다."
    ],
    "blank": [
      7,
      "a price consensus",
      "상호 한계를 이해한 결과이지 일방적 가격 강요가 아니다."
    ],
    "vocab": [
      [
        "restriction",
      ...
      [
        "low → high",
        "낮은 → 높은",
        "비필수품에는 지나치게 높은 가격을 요구하기 어려움"
      ]
    ],
    "answer": "④ low → high. 게임을 필수품으로 보지 않는 구매자는 너무 비싸면 사지 않을 수 있다.",
    "edits": [
      [
        6,
        "very low prices",
        "very high prices",
        "필수성이 낮으므로 높은 가격 요구를 피함"
      ]
    ],
    "turns": [
      6
  ...
  },
  {
    ...
    "compare": [
      [
        ...
        "value of place",
        "물리적 생산 제약 vs 문화·윤리적 연결",
        "특정 지역 재료만 써야 한다는 제약이 사라졌다고 생산지의 사람·자원 가치까지 불필요해지는 것은 아니다."
      ]
    ],
    "refs": [
      [
      ...
      [
        6,
        "This",
        "S5의 생산지·방법·생산자와 연결감 없이 만들고 소비하는 상황 전체"
      ],
      [
        6,
        "these products",
    ...
    "syntax": [
      [
        5,
        "where, how, or by whom the products were made는 connection의 대상을 이루는 간접의문 내용이다. 장소·방법·생산자 세 축을 병렬로 묻는다."
      ]
    ],
    "central": "생산과 소비가 장소에서 분리되며 잃은 사람·기술·자원에 대한 이해를 장소의 가치 회복으로 되살려야 한다.",
    "tip": "장소의 물리적 제약에서 벗어남과 생산 맥락을 존중해야 함은 서로 다른 차원이다.",
    "topicEN": "Restoring connections to place in textile production and consumption",
    "titleEN": "Reconnect Clothes with the Places Behind Them",
    "order": [
      [
        1,
        2,
    ...
    "insert": [
      6,
      "This가 S5의 연결 부재 전체를 받아 손실을 나열하고 Therefore의 해결을 준비한다."
    ],
    "blank": [
      7,
      "reconnects",
      "disconnect를 되돌리는 해결의 방향이다."
    ],
    "vocab": [
      [
        "place-bound",
    ...
    "answer": "④ countered → caused 또는 created. 연결 부재는 단절을 해소하지 않고 만들어 낸다.",
    "edits": [
      [
        6,
        "countered",
        "caused",
        "S5의 little or no connection이 단절의 원인"
      ]
    ],
    "turns": [
      6,
