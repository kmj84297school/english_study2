...
window.EXAM_DATA["claim"] = [
  {
    ...
    "flow": [
      ...
      [
        ...
        2,
        2,
        "누구와 비교해 부족한지 셰익스피어를 대조한다."
      ],
      [
        "실제 기여",
        3,
        4,
        "인정할 이유를 언어·문학적 성과로 입증한다."
      ],
      [
        "인정 촉구",
        5,
        5,
        "성과가 있으므로 연구·평가에 포함해야 한다."
      ]
    ],
    "connectors": [
      [
        2,
        "Unlike",
        "셰익스피어는 언어 발전의 공로를 인정받는다.",
        "비슷한 기여를 한 현대 작사가는 무시된다."
      ],
      [
        4,
        "Producing",
    ...
    "compare": [
      [
        ...
        "큰 영향을 끼침(S3–4)",
        "평가 vs 실제 성과",
        "주어는 연구자의 평가와 작사가의 활동으로 다르다. 영향이 없다는 말이 아니라 영향에 비해 인정이 부족하다는 문제다."
      ]
    ],
    "refs": [
      [
        3,
        "these artists / who",
        "S2의 modern songwriters"
      ],
      [
        5,
        "Their",
        "현대 작사가들. 바로 앞 imagery가 아니다."
      ]
    ],
    "syntax": [
      [
        2,
        "주어 modern songwriters → 동사 have experienced / been ignored → 목적어 restraints. Unlike Shakespeare는 비교 기준, who절은 Shakespeare를 수식한다."
      ],
      [
        4,
        "주어 songwriters → 동사 have had → 목적어 an impact. Producing은 작사가들의 행위를 나타내는 분사구문이다."
      ]
    ],
    "central": "문학 연구는 현대 작사가가 언어와 문학 발전에 기여한 바를 정당하게 인정해야 한다.",
    "tip": "셰익스피어는 중심 대상이 아니라 작사가에 대한 불공정한 평가를 드러내는 비교 기준이다.",
    "topicEN": "Recognition of modern songwriters’ contributions to language and literature",
    "titleEN": "Songwriters Deserve a Place in Literary Study",
    "order": [
      [
        1,
        2,
    ...
    "insert": [
      2,
      "S1의 미인정을 받은 뒤 비교 사례를 들고, S3의 these artists가 작사가를 이어받는다."
    ],
    "blank": [
      5,
      "must be recognized",
      "S1의 failed to recognize와 대칭을 이루는 해결책이다."
    ],
    "vocab": [
      [
        "recognize",
        "인정하다",
        "처음의 부정과 마지막의 당위를 잇는 핵심어"
      ],
      [
        "contribution",
        "기여",
    ...
    "answer": "②. 인정의 대상은 작사가의 언어·문학적 기여이다. ①은 심상이라는 근거를 창작 지침으로, ③은 비교 대상을 중심으로, ④·⑤는 주장에 없는 감상·비교 연구 과제로 바꾼다.",
    "turns": [
      5
    ],
    "id": "claim-01",
  ...
  },
  {
    ...
    "connectors": [
      ...
      [
        ...
        "Without",
        "명확한 기준 마련을 주장",
        "기준이 없을 때 구분 불가능하다는 반대 조건으로 입증"
      ]
    ],
    "compare": [
      [
        "some knowingly(S5)",
        "many unintentional(S5)",
        "집단의 일부 vs 다른 다수",
        "동일한 직원이 동시에 고의·비고의라는 말이 아니다. 일부의 악의를 모든 직원에게 일반화하면 틀린다."
      ]
    ],
    "refs": [
      [
        2,
        "this",
        "S1의 지각·폭언 문제를 없애는 목표 전체"
      ],
      [
        3,
        "This",
        "S2의 문제 직원을 찾아 처벌하는 접근 전체"
      ],
      [
        6,
        "them",
    ...
    "syntax": [
      [
        4,
        "주어 one common reason → 동사 is → 보어 that they were unaware…. 앞의 that employees give는 reason을 수식하는 관계절이다."
      ]
    ],
    "central": "기업은 직원의 위반을 모두 고의로 보지 말고 명확한 행동 기준과 실천 방법을 교육해야 한다.",
    "tip": "bad apples와 uninformed apples는 같은 위반 행동을 보일 수 있지만 원인이 다르다.",
    "topicEN": "Clear standards and employee education as responses to misconduct",
    "titleEN": "Before Punishment, Make the Rules Clear",
    "order": [
      [
        1,
        3,
    ...
    "insert": [
      4,
      "This로 처벌의 전제를 밝힌 S3 뒤에서 In fact가 이를 반박한다."
    ],
    "blank": [
      6,
      "create clear standards",
      "S4의 unaware를 해소하고 S7의 these standards를 제공한다."
    ],
    "vocab": [
      [
        "on purpose",
    ...
    "answer": "②. 명확한 행동 기준과 교육이 직접적인 대안이다. 처벌 강화(③)는 글이 한계를 지적한 대응이며 보상·동료 평가는 핵심 근거가 없다.",
    "turns": [
      4,
      6
    ],
  ...
  },
  {
    ...
    "flow": [
      ...
      [
        ...
        5,
        5,
        "통제 범위를 넘는 순간 평가가 달라진다."
      ],
      [
        "발생 여부 양쪽 검토",
        6,
        7,
        "발생하지 않아도, 발생해도 끝없는 걱정은 도움이 안 된다."
      ],
      [
        "의식적으로 중단",
        8,
        8,
        "대비가 아닌 무한한 걱정을 줄이라는 결론이다."
      ]
    ],
    "connectors": [
      [
    ...
    "compare": [
      [
        "helpful(S4)",
        "unnecessary suffering(S5)",
        "정도·통제 조건",
        "주어가 넓게는 걱정이지만 S4는 제한적 사전 검토, S5는 통제 불가능한 과잉이다."
      ],
      [
        "did not take place(S6)",
        "actually occurred(S7)",
        "가정 조건",
        "동일 사건의 상반된 사실 진술이 아니라 비발생·발생 두 경우를 나누어 검토한다."
      ]
    ],
    "refs": [
      [
      ...
      [
        7,
        "that situation / it",
        "S6의 끔찍한 상황; it only goes to show의 it은 그 상황이 발생했다는 사실"
      ]
    ],
    "syntax": [
      [
        5,
        "When절은 조건·상황 → 주절 they cause us unnecessary suffering. however는 주절의 판단이 앞의 helpful과 달라짐을 표시한다."
      ]
    ],
    "central": "유용한 사전 대비와 달리 통제할 수 없는 미래에 대한 끝없는 걱정은 의식적으로 줄여야 한다.",
    "tip": "S7은 S6의 사실을 뒤집는 문장이 아니라 반대 경우를 가정해도 결론이 유지됨을 보여준다.",
    "topicEN": "Limiting excessive worry about uncertain future events",
    "titleEN": "Prepare for the Future, but Stop Endless Worry",
    "order": [
      [
        1,
        4,
    ...
    "insert": [
      5,
      "helpful을 인정한 뒤 however로 조건을 바꾸고 고통의 사례를 이어야 한다."
    ],
    "blank": [
      8,
      "stop worrying endlessly",
      "normal·helpful이 있어 stop all preparation은 범위가 과도하다."
    ],
    "vocab": [
      [
        "in anticipation of",
    ...
    "answer": "②. 일어나지 않을 수 있는 일에 대한 과도한 걱정을 줄이라는 주장이다. 원인 분석이나 계획 구체화 자체를 결론으로 삼지 않는다.",
    "turns": [
      5
    ],
    "id": "claim-03",
  ...
  },
  {
    ...
    "flow": [
      ...
      [
        ...
        2,
        3,
        "장점이 왜 학습으로 이어지지 않는지 짚는다."
      ],
      [
        "가능성 재평가",
        4,
        4,
        "많은 기존 게임의 한계가 모든 가능성을 지우지는 않는다."
      ],
      [
        "학습 연계 게임 개발",
        5,
        5,
        "가능성을 구체적 설계 방향으로 바꾼다."
      ],
      [
        "몰입과 학습의 결합",
        6,
    ...
    "compare": [
      [
        ...
        "could enhance(S4)",
        "현존 게임의 경향 vs 활용 가능성",
        "현재 많은 게임의 성과 부족과 새로 설계한 게임의 잠재력은 대상과 조건이 다르다."
      ]
    ],
    "refs": [
      [
      ...
      [
        6,
        "This",
        "S5의 학습 성과와 연결된 게임 개발"
      ]
    ],
    "syntax": [
      [
        4,
        "While절은 양보 → 주어 we → 동사 are ignoring → 목적어 a valuable tool. that could be used는 tool을 수식한다."
      ]
    ],
    "central": "게임의 주의 집중 능력을 활용하도록 학습 성과와 연결되는 게임을 개발해야 한다.",
    "tip": "가장 중요한 전환은 While…의 주절이다. 앞의 부정적 통념을 저자의 최종 견해로 읽지 말자.",
    "topicEN": "Developing games linked to educational outcomes",
    "titleEN": "Turn Gaming Attention into Learning",
    "order": [
      [
        1,
        3,
    ...
    "insert": [
      4,
      "S3의 한계를 this로 받아 양보한 후 S5의 Rather 대안을 준비한다."
    ],
    "blank": [
      5,
      "connect to the learning outcomes",
      "휴식용 게임이 아니라 교육 목적과의 연결이 핵심이다."
    ],
    "vocab": [
      [
        "at best",
    ...
    "answer": "①. 학습 효과에 활용할 게임의 개발이다. ② 시간 배분·④ 여가 활용은 학습과 게임을 분리하며, ③ 집중력 저하는 원문의 집중력 장점과 반대다.",
    "turns": [
      3,
      5
    ],
  ...
  },
  {
    ...
    "flow": [
      ...
      [
        ...
        2,
        3,
        "전제를 훼손하는 확산 구조를 설명한다."
      ],
      [
        "사용자 참여와 피해",
        4,
        4,
        "사회적 결과를 보여 책임 논의로 이어진다."
      ],
      [
        "사실 확인의 책임",
        5,
        6,
        "정확성과 공동체 신뢰를 지키는 해결책이다."
      ]
    ],
    "connectors": [
      [
    ...
    "compare": [
      [
        "may unknowingly(S4)",
        "our responsibility(S5)",
        "의도 vs 책임",
        "고의가 아닐 가능성을 인정해도 정보 생산·소비자의 사실 확인 책임이 사라지는 것은 아니다."
      ]
    ],
    "refs": [
      [
      ...
      [
        4,
        "which",
        "잘못된 정보(misinformation); 선거·폭력·공포에 영향을 미치는 내용"
      ],
      [
        5,
        "our",
    ...
    "syntax": [
      [
        1,
        "주어 Truth → 동사 is → 보어 essential. as절은 이유, upon which절은 foundation을 수식한다."
      ],
      [
        5,
        "it은 가주어, to take on…이 진주어. As creators and consumers는 우리의 역할을 밝힌다."
      ]
    ],
    "central": "소셜 미디어 이용자는 사실 확인을 강화해 정보의 정확성과 신뢰성을 지켜야 한다.",
    "tip": "기업의 개인정보 보호가 아니라 정보 생산자이자 소비자인 이용자의 정확성 확보 책임이다.",
    "topicEN": "Social media users’ responsibility for reliable information",
    "titleEN": "Fact-Checking Is a Shared Responsibility",
    "order": [
      [
        1,
        1,
    ...
    "insert": [
      5,
      "S4에서 사용자의 문제 참여를 설명한 뒤 생산자·소비자의 책임으로 전환한다."
    ],
    "blank": [
      5,
      "enhancement of fact-checking protocols",
      "misinformation의 확산을 정확성 검증으로 해결한다."
    ],
    "vocab": [
      [
        "misinformation",
    ...
    "answer": "③. 정보 정확성과 신뢰성 확보가 핵심이다. 이용자 의견 반영·저작권·개인정보는 원문이 논의한 문제와 다르다.",
    "turns": [
      2,
      5
    ],
  ...
  },
  {
    ...
    "connectors": [
      ...
      [
        ...
        "in light of",
        "인간의 오류 가능성 인정",
        "이를 바탕으로 감독 역할을 맡자는 결론"
      ]
    ],
    "compare": [
      [
        "human fallibility(S3)",
        "AI infallibility 근거 부족(S5)",
        "서로 다른 주체에 같은 기준 적용",
        "인간이 실수한다는 사실은 AI가 실수하지 않는다는 증거가 아니다."
      ],
      [
        "machines in general",
        "AI specifically",
        "상위·하위 범위",
        "기계 전반 안에서 AI를 초점 대상으로 좁힌다. 모든 기계의 모든 결정을 논하는 것은 아니다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        5,
        "주어 Little evidence → 동사 exists. that suggests…or predicts…는 evidence를 수식한다. Little은 거의 없다는 부정 의미다."
      ],
      [
        6,
        "가주어 It → is crucial → 진주어 that we utilize…. to overcome은 capacity를, to position은 활용 목적을 나타낸다."
      ]
    ],
    "central": "인간은 자신의 오류를 인식하고 극복하는 능력으로 AI의 성장과 활용을 감독해야 한다.",
    "tip": "However 이후 인간의 약점이 사라지는 것이 아니라 그 약점을 다뤄 온 능력이 감독의 근거가 된다.",
    "topicEN": "Human oversight of AI through the capacity to overcome errors",
    "titleEN": "Fallible Humans, Necessary Overseers of AI",
    "order": [
      [
        1,
        3,
    ...
    "insert": [
      4,
      "here가 S3의 실수 가능성을 받고 S5가 반전의 이유를 제공한다."
    ],
    "blank": [
      6,
      "overseers",
      "AI 대체·의존 거부가 아니라 오류를 감시하는 역할이다."
    ],
    "vocab": [
      [
        "fallibility",
    ...
    "answer": "⑤. 오류 극복 능력의 활용이 결론이다. ①은 양면 고려에 머물며 인간이 맡아야 할 감독 역할을 충분히 담지 못한다.",
    "turns": [
      4,
      6
    ],
  ...
  },
  {
    ...
    "compare": [
      [
        ...
        "가치 vs 충분성",
        "같은 행동화가 유익하다는 평가와 그것만으로 불충분하다는 평가는 양립한다."
      ],
      [
        "개별 행동",
        "조직 문화",
        "개인·일시적 실천 vs 집단·지속성",
        "문화 형성에는 널리 공유되고 반복되는 행동 기준이 필요하다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        6,
        "가주어 It → is critical → 진주어 to have a visual representation. that절은 specific behaviors를 수식하며 use의 목적어가 빠진 관계절이다."
      ]
    ],
    "central": "조직 문화를 만들려면 가치를 반영한 구체적 행동을 명시적·시각적 지침으로 널리 공유해야 한다.",
    "tip": "핵심 가치를 정하는 단계가 아니라 이미 정한 가치를 조직 전체 행동으로 정착시키는 단계다.",
    "topicEN": "Explicit behavioral guidelines for turning organizational values into culture",
    "titleEN": "A Playbook for Putting Values into Action",
    "order": [
      [
        1,
        3,
    ...
    "insert": [
      4,
      "this와 those behaviors가 S3의 행동화를 받아 추가 조건을 제시한다."
    ],
    "blank": [
      6,
      "visual representation",
      "S5의 단순한 말과 대조되며 S7의 playbook으로 구체화된다."
    ],
    "vocab": [
      [
        "alone",
    ...
    "answer": "⑤. 행동 공유를 위한 명시적 지침이 필요하다. ① 가치 정립이나 ④ 소통 일반은 행동 기준을 시각적으로 구체화하라는 핵심을 놓친다.",
    "turns": [
      4
    ],
    "id": "claim-07",
  ...
  },
  {
    ...
    "compare": [
      [
        ...
        "writers(S3)",
        "지식 수용 역할 vs 전달 역할",
        "동일한 과학자가 두 역할을 맡는다. 읽기를 버리고 쓰기만 하라는 교체가 아니다."
      ]
    ],
    "refs": [
      [
        3,
        "here",
        "과학자에게 읽기 능력이 중요하다는 앞의 논의"
      ],
      [
        5,
        "they / their(S6) / them(S6)",
        "scientists"
      ],
      [
        6,
        "It",
        "to understand…를 받는 가주어. 직전 명사의 대명사가 아니다."
      ]
    ],
    "syntax": [
      [
        3,
        "주어 what is often overlooked here → 동사 is → 보어 that scientists are also obliged…. what절 전체가 주어이고 that절은 완전한 내용절이다."
      ]
    ],
    "central": "과학자는 독자가 어떻게 읽는지 이해하고 독자 중심으로 글을 써야 한다.",
    "tip": "However는 읽기 부정이 아니라 쓰기 추가이며, moreover 이후에서 제목·주제의 초점이 독자 중심으로 좁혀진다.",
    "topicEN": "Reader-centered writing as an essential skill for scientists",
    "titleEN": "Good Scientists Write with Readers in Mind",
    "order": [
      [
        1,
        2,
    ...
    "insert": [
      5,
      "읽기와 쓰기의 필요를 인용한 뒤 moreover로 필자의 가독성 원칙을 보탠다."
    ],
    "blank": [
      5,
      "reader-centered mentality",
      "S6의 how readers read가 정답 범위를 독자 관점으로 한정한다."
    ],
    "vocab": [
      [
        "keep up with",
    ...
    "answer": "②. 독자 관점의 글쓰기가 결론이다. ④는 앞의 extensive reading을 다른 분야 독서로 확대하고 결론의 쓰기 초점을 놓친다.",
    "turns": [
      3,
      5
    ],
