...
window.EXAM_DATA["coherence"] = [
  {
    ...
    "compare": [
      [
        ...
        "in the long term",
        "시점·누적 범위",
        "한 번의 마감 손실과 반복되는 돌봄 포기의 누적 손실을 비교한다. 당장 업무를 택할 수 있어도 매번 그러라는 뜻이 아니다."
      ]
    ],
    "refs": [
      [
        4,
        "that happens",
        "업무 때문에 자기 돌봄부터 포기하는 일"
      ],
      [
        7,
        "this",
        "자기 돌봄을 우선하지 않는 상황 전체"
      ]
    ],
    "syntax": [
      [
        1,
        "few … who don’t want는 부정 의미가 두 겹이라 대부분은 원한다는 뜻이다."
      ],
      [
        7,
        "가주어 it → important → to recognize…and to make sure… 병렬. that절이 확인할 내용이다."
      ]
    ],
    "central": "업무 때문에 자기 돌봄을 가끔 미룰 수는 있어도 장기적으로 반복되는 일상이 되어서는 안 된다.",
    "tip": "목공은 자기 돌봄의 한 사례일 뿐이다. 목공과 다른 수업을 비교하면 글의 대립 축이 바뀐다.",
    "topicEN": "Preventing repeated neglect of self-care despite short-term work demands",
    "titleEN": "Let Skipping Self-Care Be the Exception",
    "order": [
      [
        1,
        3,
    ...
    "insert": [
      7,
      "S5의 short term을 long term으로 뒤집으므로 S6의 수업 비교를 사이에 넣지 않는다."
    ],
    "blank": [
      7,
      "the exception rather than the norm",
      "가끔은 인정하지만 반복은 막아야 한다는 범위를 담는다."
    ],
    "vocab": [
      [
        "reprioritize",
    ...
    "answer": "④(이 화면 S6). 같은 목공이라는 단어를 반복하지만 비교 대상이 업무 vs 돌봄에서 목공 vs 디자인으로 바뀐다.",
    "irrelevant": 6,
    "turns": [
      7
    ],
  ...
  },
  {
    ...
    "compare": [
      [
        ...
        "majority benefits",
        "대상 집단별 내용 차이",
        "필요하다는 결론은 같지만 소수자는 조직의 의미, 다수자는 타인의 현실·자신의 특권 이해에 초점을 둔다."
      ]
    ],
    "refs": [
      [
      ...
      [
        ...
        "S3–5의 다양한 멘토에게 배우는 기회"
      ]
    ],
    "syntax": [
      [
        7,
        "목표는 to have individuals be…: have + 목적어 + 동사원형. informed / identified / engaged가 병렬로 개인의 상태를 설명한다."
      ]
    ],
    "central": "다양한 멘토망은 소수·다수 집단 모두의 이해와 정체성, 조직 참여를 높인다.",
    "tip": "같은 mentoring을 말해도 S6은 workers에서 employers로 주체가 바뀌고 다양성이라는 초점도 빠진다.",
    "topicEN": "The value of diverse mentoring networks for all workers",
    "titleEN": "Different Mentors, Shared Benefits",
    "order": [
      [
        1,
        3,
    ...
    "insert": [
      5,
      "S3의 두 집단 중 S4에서 소수를 설명했으므로 다음에는 다수의 이점이 와야 균형이 완성된다."
    ],
    "blank": [
      3,
      "dominant and minority group members alike",
      "이후 각각 한 문장씩 설명하는 병렬 구조를 예고한다."
    ],
    "vocab": [
      [
        "diverse",
    ...
    "answer": "④(이 화면 S6). 고용주의 개인적 성장이라는 주체·초점이 논의에서 벗어난다.",
    "irrelevant": 6,
    "turns": [
      3
    ],
  ...
  },
  {
    ...
    "compare": [
      [
        ...
        "존재 지속 vs 크기 변화",
        "빙하가 여름마다 완전히 사라지지 않는 것과 면적이 해마다 똑같은 것은 다르다."
      ],
      [
        "many small mountain glaciers",
        "all glaciers",
        "하위 범주 vs 전체",
        "마지막 전망을 모든 빙하의 확정적 소멸로 확대하면 안 된다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        7,
        "It is estimated that…는 추정 내용을 제시하는 수동 구문. unless절은 추정 결과의 조건이며 확정적 사실 진술과 구분한다."
      ]
    ],
    "central": "기록과 위성 자료는 온난화에 따른 산악 빙하 감소를 보여 주며, 추세가 계속되면 작은 빙하의 소멸이 우려된다.",
    "tip": "영구성은 크기 불변이 아니며, 마지막 소멸 시한은 원문 작성 시점의 조건부 전망으로 읽어야 한다.",
    "topicEN": "Evidence and projected consequences of accelerating glacier loss",
    "titleEN": "Permanent Ice under a Warming Climate",
    "order": [
      [
        1,
        2,
    ...
    "insert": [
      4,
      "This가 S3의 감소 현상을 받아 첫 기록 증거를 제시하고 S5가 위성 증거로 확대한다."
    ],
    "blank": [
      7,
      "unless there is a sudden and unexpected change",
      "추세의 지속이라는 조건을 빠뜨리면 확정 예측으로 변형된다."
    ],
    "vocab": [
      [
        "permanent",
    ...
    "answer": "④(이 화면 S6). 빙하의 감소 추세와 무관한 학교 과학 프로젝트 이야기다.",
    "irrelevant": 6,
    "turns": [
      3,
      7
  ...
  },
  {
    ...
    "compare": [
      [
        "sport and tourism generally",
        "sports tourism specifically",
        "넓은 두 분야 vs 결합된 특정 활동",
        "일반적 관광 산업 전체가 아닌 스포츠 참여·관람을 위한 여행에 초점을 좁힌다."
      ],
      [
        "invention",
        "mass transport",
        "시점·보급 범위",
        "발명되었다고 곧 대중이 사용한 것은 아니다."
      ]
    ],
    "refs": [
      [
      ...
      [
        7,
        "it",
        "자동차. 직전 S6의 accommodation이 아님"
      ],
      [
        7,
        "those",
        "여러 forms of sports tourism 중 외진 장소를 필요로 하는 형태"
      ]
    ],
    "syntax": [
      [
        5,
        "has advantages of affording…and allowing…이 병렬. not served by public transport는 areas를 수식한다."
      ]
    ],
    "central": "자동차의 대중화는 접근성과 사람·장비 운반의 유연성을 높여 특히 외진 지역의 스포츠 관광을 발전시켰다.",
    "tip": "transportation이라는 큰 말 안에서도 장비 운반과 대중교통 밖 지역 접근이 결론을 만드는 구체적 근거다.",
    "topicEN": "The automobile’s contribution to the development of sports tourism",
    "titleEN": "Cars Take Sports Tourism Further",
    "order": [
      [
        1,
        3,
    ...
    "insert": [
      7,
      "it은 car를 받고 As a result는 S5의 접근·운반 장점을 결론으로 연결한다."
    ],
    "blank": [
      5,
      "access to many areas not served by public transport",
      "S7의 relatively remote locations와 대응한다."
    ],
    "vocab": [
      [
        "afford access",
    ...
    "answer": "④(이 화면 S6). 숙박시설→식당 성장이라는 별개의 인과가 자동차→스포츠 관광 논리를 끊는다.",
    "irrelevant": 6,
    "turns": [
      5,
      7
  ...
  },
  {
    ...
    "flow": [
      ...
      [
        ...
        4,
        5,
        "지역·해외·비공개 매물까지 정보가 온다."
      ],
      [
        "목록 발신과 수집 확대",
        7,
        7,
        "반대로 요청을 보내 수집 가능성을 높인다."
      ]
    ],
    "connectors": [
      [
    ...
    "compare": [
      [
        ...
        "상위 일반 장점 vs 현재 세부 과정",
        "S6은 완전히 다른 주제가 아니라 너무 넓은 요약이다. 현재의 정보 수신·발신 연결을 설명하지 못하는 점을 봐야 한다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        5,
        "items which are not yet… but might be…: 관계절 안에서 현재 판매 상태와 조건부 구매 가능성을 대조한다."
      ]
    ],
    "central": "전문 거래상의 넓고 깊은 정보망은 고객의 희망 물건을 탐색하고 수집품을 확대할 가능성을 높여 준다.",
    "tip": "무관한 문장은 꼭 완전히 다른 소재일 필요가 없다. S6은 큰 주제와 닮았어도 In turn의 정보망 연결을 끊는다.",
    "topicEN": "Dealers’ networks as a resource for expanding collections",
    "titleEN": "A Dealer’s Network Opens a Collector’s Possibilities",
    "order": [
      [
        1,
        2,
    ...
    "insert": [
      7,
      "In turn은 S5의 정보 수신을 받아 반대 방향의 희망 목록 발신을 제시한다."
    ],
    "blank": [
      3,
      "a much wider network",
      "다른 도시·해외·개인 거래·희망 목록의 공통 기반이다."
    ],
    "vocab": [
      [
        "from stock",
    ...
    "answer": "④(이 화면 S6). 맞춤 서비스라는 일반론이 현재의 넓은 정보망을 통한 정보 수신·발신 흐름을 끊는다.",
    "irrelevant": 6,
    "turns": [
      7
    ],
  ...
  },
  {
    ...
    "compare": [
      [
        ...
        "unable to reproduce",
        "정보 저장 vs 실행 능력",
        "기억에 노래가 있어도 듣고 조절하는 연습이 없으면 정확한 발성은 안 된다."
      ]
    ],
    "refs": [
      [
      ...
      [
        7,
        "This process",
        "S5의 본보기에 맞춰 발성을 미세 조정하는 과정. S6의 선호·제약이 아니다."
      ]
    ],
    "syntax": [
      [
        7,
        "are unable to reproduce가 주절. if절의 after memorization but before practice는 청각 상실의 시점을 한정해 기억 실패와 구별한다."
      ]
    ],
    "central": "새는 기억한 노래를 자기 발성을 듣고 조절하는 연습을 통해 정확히 재현한다.",
    "tip": "이 글의 범위는 노래 학습의 전체 원인 목록이 아니라 기억→연습→청각 피드백의 과정이다.",
    "topicEN": "Practice and auditory feedback in reproducing memorized birdsong",
    "titleEN": "Remember, Practice, Listen: How Birds Learn Songs",
    "order": [
      [
        1,
        2,
    ...
    "insert": [
      7,
      "This process가 S5의 fine-tuning을 직접 받도록 이어야 한다."
    ],
    "blank": [
      7,
      "hearing oneself sing",
      "기억 후 청각을 잃으면 재현하지 못한다는 실험적 조건이 뒷받침한다."
    ],
    "vocab": [
      [
        "memorize",
    ...
    "answer": "④(이 화면 S6). 선호와 제약은 기억한 노래를 연습·조절하는 단계 설명에 연결되지 않는다.",
    "irrelevant": 6,
    "turns": [
      5,
      7
  ...
  },
  {
    ...
    "compare": [
      [
        ...
        "brain idling",
        "서로 다른 처리 체계",
        "같은 사람 안에서도 발화와 내용 선택의 속도는 다를 수 있다."
      ],
      [
        "intersection / fender bender",
        "choice / filler",
        "비유 vs 실제",
        "교통사고 자체가 아니라 선택 지연으로 나오는 군말을 설명한다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        6,
        "When절 안의 두 절을 and로 연결한다. 주절 that’s when…은 그 조건이 군말이 발생하는 순간임을 강조한다."
      ]
    ],
    "central": "뇌가 말을 선택할 시간보다 입이 빠르게 움직이면 내용 공급이 끊겨 군말이 나온다.",
    "tip": "글의 인과는 빠른 발화→뇌의 선택과 불일치→군말이다. 좋은 판단→빠른 말이라는 S5는 방향을 바꾼다.",
    "topicEN": "Filler words caused by a mismatch between speaking and thinking speed",
    "titleEN": "When the Mouth Outruns the Mind",
    "order": [
      [
        1,
        3,
    ...
    "insert": [
      6,
      "S4의 뇌 정지 상태 뒤에 뇌가 안내하지 못할 때 입에서 생기는 결과가 와야 한다."
    ],
    "blank": [
      6,
      "filler",
      "마지막의 Um, ah, you know, like가 구체적인 예다."
    ],
    "vocab": [
      [
        "idle",
    ...
    "answer": "③(이 화면 S5). 뇌의 판단 지연 때문에 빠른 말이 위험하다는 흐름을 빠른 말의 이점으로 바꾼다.",
    "irrelevant": 5,
    "turns": [
      3,
      6
  ...
  },
  {
    ...
    "compare": [
      [
        ...
        "acceptance and use",
        "공급 vs 실제 채택",
        "제도가 있다고 모든 직원이 쓰는 것은 아니다."
      ],
      [
        "current barriers",
        "will gradually reduce",
        "현재 vs 미래 전망",
        "장벽이 지금 있다고 장기 확산도 불가능한 것은 아니다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        5,
        "긴 병렬 주어 advances / expansion / desire → 동사 are → 보어 only three of the many factors. that절은 factors를 수식한다."
      ]
    ],
    "central": "원격근무에는 수용 장벽이 있지만 기술·노동·생활의 변화와 조직의 이익이 그 장벽을 줄이고 확산을 촉진한다.",
    "tip": "현재의 사용 제약과 미래 확산의 방향을 구분해야 Despite 이후가 자연스럽다.",
    "topicEN": "Forces promoting telecommuting despite existing adoption barriers",
    "titleEN": "Telecommuting Grows Beyond Its Barriers",
    "order": [
      [
        1,
        2,
    ...
    "insert": [
      5,
      "S3의 새 문화 등장 뒤에서 그 변화를 지속시킬 구체적 요인이 나온다."
    ],
    "blank": [
      3,
      "Despite these limitations",
      "장벽을 없었다고 취소하지 않고 그것을 인정한 채 확산을 말한다."
    ],
    "vocab": [
      [
        "telecommuting",
    ...
    "answer": "③(이 화면 S4). 직원 선발 지침은 장벽과 원격근무 확산을 설명하는 전체 흐름에서 벗어난다.",
    "irrelevant": 4,
    "turns": [
      3
    ],
