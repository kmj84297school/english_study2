...
window.EXAM_DATA["sequence"] = [
  {
    ...
    "compare": [
      [
        ...
        "repetitive process",
        "관찰 규모·겉모습 vs 미시 기제",
        "전체적으로 연속처럼 보이는 과정도 작은 사건 단위에서는 반복으로 설명된다. 같은 규모의 정반대 명제가 아니다."
      ]
    ],
    "refs": [
      [
      ...
      [
        7,
        "here / this",
        "양초의 연소 / 반복적인 왁스 분자의 연소 과정"
      ],
      [
        8,
        "like this",
        "양초처럼 겉으로는 반복이 잘 보이지 않는 것"
      ],
      [
        9,
        "It",
    ...
    "syntax": [
      [
        9,
        "It seems to yield… but does not: 콜론 뒤는 반박 이유. although on a large scale…은 겉보기 예외를 인정하는 절이다."
      ]
    ],
    "central": "시계는 물리적 모양보다 반복 과정이 본질이며 연속적으로 보이는 양초나 탄소 연대 측정도 이 기준으로 설명된다.",
    "tip": "B의 another·like this는 A의 양초 사례가 먼저 있어야 이해된다. C의 일반 정의가 두 사례보다 앞선다.",
    "topicEN": "Repetitive processes as the defining nature of clocks",
    "titleEN": "Every Clock Is a Repeating Process",
    "order": [
      [
        3,
        4,
    ...
    "insert": [
      8,
      "another와 like this가 S6–7의 양초를 가리키므로 반드시 그 사례 뒤에 놓인다."
    ],
    "blank": [
      2,
      "the nature of that process is repetitive",
      "일반 시계와 두 겉보기 예외를 모두 포괄한다."
    ],
    "vocab": [
      [
        "embodied",
    ...
    "answer": "④ C → A → B. C에서 반복 정의·예시 → A에서 Indeed로 강화하고 양초 반례 해소 → B의 another·like this로 같은 유형의 두 번째 사례.",
    "turns": [
      2,
      7
    ],
  ...
  },
  {
    ...
    "flow": [
      ...
      [
        ...
        6,
        6,
        "포괄적 이해에는 다른 근거가 필요하다."
      ],
      [
        "경험·실험으로 보완",
        7,
        7,
        "협력이 무엇인지 구체적으로 결론 낸다."
      ]
    ],
    "connectors": [
      [
    ...
    "compare": [
      [
        ...
        "유용성 vs 충분성",
        "철학이 가치 있다는 것과 철학만으로 의식을 모두 이해할 수 있다는 것은 다르다."
      ],
      [
        "non-empirical",
        "empirical",
        "방법의 차이",
        "논리 검토와 관찰·실험은 경쟁적 대체만이 아니라 상호 보완 관계로 제시된다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        7,
        "This means that [while philosophy can provide…, it needs to be supplemented…]. that절 안에 양보절과 주절이 들어 있으며 while절이 결론을 끝내지 않는다."
      ]
    ],
    "central": "철학은 넓은 통찰과 질문을 제공하지만 의식을 포괄적으로 이해하려면 경험적 신경과학과 협력해야 한다.",
    "tip": "A의 This means는 바로 앞의 협력 필요를 풀어 쓴다. 철학의 가치 인정과 보완 필요를 찬반의 모순으로 보지 말자.",
    "topicEN": "Complementarity between philosophy and empirical neuroscience",
    "titleEN": "Big Questions Need Empirical Partners",
    "order": [
      [
        3,
        4,
    ...
    "insert": [
      7,
      "This means는 S6의 협력 필요를 경험·실험의 보완으로 설명하므로 그 뒤에 와야 한다."
    ],
    "blank": [
      7,
      "supplemented by empirical findings and experiments",
      "철학이 비경험적이라는 S4의 한계를 보완한다."
    ],
    "vocab": [
      [
        "interdisciplinary",
    ...
    "answer": "⑤ C → B → A. C의 비경험적 방법 → B의 질문 중심 기여와 협력 필요 → A의 This means로 협력의 구체적 의미.",
    "turns": [
      6
    ],
    "id": "sequence-02",
  ...
  },
  {
    ...
    "compare": [
      [
        "teachers assign/evaluate",
        "no involvement in process",
        "전체 수업 vs 글 쓰는 도중",
        "교사가 수업에 전혀 없다는 뜻이 아니다. 작성 전·후 개입은 있지만 작성 중의 참여가 없다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        4,
        "주어 students → have conferences. during which절 안 receive feedback / make revisions / carry on writing이 병렬. based on…은 revisions의 근거를 덧붙인다."
      ]
    ],
    "central": "과정 중심 쓰기는 작성 중 피드백과 재작성을 통해 결과물 평가보다 수정과 독자 관점의 개선을 강조한다.",
    "tip": "전통 수업에 교사가 있다는 사실과 쓰기 과정에 교사가 참여하지 않는다는 말은 범위가 다르다.",
    "topicEN": "Process writing as a shift from evaluation to revision",
    "titleEN": "Writing Improves in the Process, Not Just at the End",
    "order": [
      [
        2,
        3,
    ...
    "insert": [
      2,
      "Subsequently는 S1의 학생 작성 다음 단계이며 여기서 기존 방식 설명을 마쳐야 A의 대조가 성립한다."
    ],
    "blank": [
      6,
      "from evaluation to revision",
      "전통과 과정 중심 방식의 차이를 가장 압축적으로 담는다."
    ],
    "vocab": [
      [
        "product-oriented",
    ...
    "answer": "④ C → A → B. C가 전통 방식의 후속 단계 → A가 on the other hand로 대조 → B가 In this way로 효과를 정리.",
    "turns": [
      4
    ],
    "id": "sequence-03",
  ...
  },
  {
    ...
    "compare": [
      [
        "not understand it",
        "recognise it as mathematics",
        "내용 이해 vs 분류",
        "무슨 계산인지 몰라도 수학 기호로 수학이라고 분류할 수 있다. 두 인지 수준은 다르다."
      ],
      [
        "mathematics",
        "modern notation",
        "활동·내용 vs 표현 수단",
        "표현 체계가 늦게 생겨도 그 이전 수학 활동은 존재할 수 있다."
      ]
    ],
    "refs": [
      [
      ...
      [
        4,
        "those",
        "strange dashes, squiggles and letters"
      ],
      [
        7,
        "that",
        "자료 속에 수학적인 내용·활동이 있음을 알아보는 것"
      ]
    ],
    "syntax": [
      [
        6,
        "there has to be something mathematical going on: something을 mathematical과 going on이 뒤에서 꾸민다. for us to say…는 판별이 성립할 조건·목적 맥락이다."
      ]
    ],
    "central": "수학적 글은 현대 기호만이 아니라 실제 수학적 내용으로 식별해야 하므로 고대의 낯선 자료는 판별하기 어렵다.",
    "tip": "B의 질문에 A가 ‘기호’라는 잠정 답을 주고 그 한계를 설명한 뒤 C가 내용 기준으로 정리한다.",
    "topicEN": "Recognizing mathematics beyond modern notation",
    "titleEN": "Mathematics Before the Symbols",
    "order": [
      [
        2,
        3,
    ...
    "insert": [
      4,
      "S3의 판별 기준 질문 직후 obvious signs로 기호를 답해야 B→A 연결이 성립한다."
    ],
    "blank": [
      6,
      "something mathematical going on",
      "표기 자체가 아니라 실제 수학적 활동이 핵심이다."
    ],
    "vocab": [
      [
        "notation",
    ...
    "answer": "② B → A → C. B의 질문 → A의 기호라는 답과 역사적 반박 → C의 Put simply로 내용 기준 정리.",
    "turns": [
      3,
      6
    ],
  ...
  },
  {
    ...
    "compare": [
      [
        ...
        "health problems",
        "서로 다른 효과 경로",
        "기술은 생활 조건을 개선하면서도 신체 활동을 줄여 다른 건강 위험을 만들 수 있다. 모든 변화가 전적으로 나쁘다는 말이 아니다."
      ]
    ],
    "refs": [
      [
        3,
        "such activity",
        "S2의 일·이동·가사에 필요한 신체 활동"
      ],
      [
        5,
        "these changes",
        "S3–4의 신체 활동을 줄인 기술적 변화"
      ],
      [
        6,
        "which",
      ...
      [
        ...
        "충분한 활동 부족과 여러 건강 문제의 관련"
      ]
    ],
    "syntax": [
      [
        6,
        "주어 Lack of sufficient physical activity → has been linked to…. almost all of which는 앞의 건강 상태들에 대한 추가 설명이다."
      ]
    ],
    "central": "현대의 기계화는 생활을 편리하게 했지만 일상 신체 활동을 줄여 건강과 안녕에 부작용을 낳았다.",
    "tip": "A의 these changes는 C의 활동 제거와 A의 구체적 나열을 받고, A의 problems를 B가 건강 문제로 풀어 쓴다.",
    "topicEN": "Health costs of reduced physical activity in modern life",
    "titleEN": "Convenience Has a Physical Cost",
    "order": [
      [
        2,
        3,
    ...
    "insert": [
      6,
      "S5의 many problems 직후 건강 문제를 구체화한다."
    ],
    "blank": [
      3,
      "engineered such activity out of our lives",
      "자동화·이동·가사의 변화를 한 표현으로 묶는다."
    ],
    "vocab": [
      [
        "manual",
    ...
    "answer": "④ C → A → B. 먼 과거→한 세기 전·현대 변화(C)→구체적 변화와 문제 예고(A)→건강 문제(B).",
    "turns": [
      5
    ],
    "id": "sequence-05",
  ...
  },
  {
    ...
    "connectors": [
      ...
      [
        ...
        "Nor / Before(S10)",
        "비선형계라는 조건",
        "분기점 통과도 필요·그 전에는 질서 가능"
      ]
    ],
    "compare": [
      [
        "chaos generated by iteration",
        "not all iteration leads to chaos",
        "필요 조건 vs 충분 조건",
        "혼돈에 반복이 필요하다고 해서 반복하는 모든 과정이 혼돈적이라는 역명제가 성립하지 않는다."
      ],
      [
        "nonlinear system",
        "chaotic system",
        "상위 범주 vs 조건부 하위 상태",
        "비선형계 중에서도 글에서 제시한 분기점 조건을 만족해야 혼돈 상태가 된다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        9,
        "Nor are all nonlinear systems chaotic: 부정어 Nor가 앞에 나와 be동사 도치. not all의 부분 부정이므로 어느 비선형계도 혼돈적이지 않다는 뜻이 아니다."
      ]
    ],
    "central": "자기 진자의 혼돈적 움직임은 반복과 관련되지만 반복만으로 충분하지 않고 비선형성과 분기점이라는 조건을 따져야 한다.",
    "tip": "C의 not all iteration이 A의 조건 설명을 요구한다. 필요 조건을 충분 조건으로 뒤집지 말자.",
    "topicEN": "Conditions under which iteration gives rise to chaos",
    "titleEN": "Repetition Alone Is Not Chaos",
    "order": [
      [
        3,
        5,
    ...
    "insert": [
      8,
      "S7이 반복만으로는 충분하지 않다고 한 뒤 구체적 조건을 제시한다."
    ],
    "blank": [
      7,
      "not all iteration leads to chaos",
      "다음 비선형계·분기점 조건을 여는 핵심 한정이다."
    ],
    "vocab": [
      [
        "pendulum",
    ...
    "answer": "③ B → C → A. 장치의 실행(B)→경로 차이와 반복만으로는 부족함(C)→혼돈 발생 조건(A).",
    "turns": [
      7,
      8
    ],
  ...
  },
  {
    ...
    "compare": [
      [
        ...
        "market enforcement",
        "행동 가능성 vs 유인·제재",
        "위반이 물리적으로 불가능해지는 것은 아니다. 위반했을 때 미래 거래를 잃을 비용이 생긴다."
      ],
      [
        "farmer",
        "landowner",
        "상호 대칭 주체",
        "감독받는 농부만 아니라 지주도 평판 제재의 대상이다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        1,
        "when contracting parties have developed… 조건절. that can be devalued는 reputational capital 수식, when contracts are violated는 가치 하락의 조건이다."
      ]
    ],
    "central": "공유되고 축적되는 평판은 계약 위반자에게 미래 거래 손실을 안겨 농부와 지주 모두의 계약 이행을 유도한다.",
    "tip": "A의 Similarly는 B 끝의 농부 위반 사례를 지주에게 대칭적으로 적용한다. C에서 등장인물과 평판을 먼저 소개해야 한다.",
    "topicEN": "Reputational capital as a mechanism of market enforcement",
    "titleEN": "A Good Name Is a Contract’s Collateral",
    "order": [
      [
        2,
        3,
    ...
    "insert": [
      7,
      "Similarly는 S6의 농부 태만을 받아 지주의 태만을 병렬로 놓는다."
    ],
    "blank": [
      5,
      "act as a bond",
      "S8의 미래 거래 거부 가능성이 평판을 잃을 비용을 만든다."
    ],
    "vocab": [
      [
        "enforcement",
    ...
    "answer": "⑤ C → B → A. C에서 농부·지주와 평판 소개 → B에서 감시와 농부 위반 → A의 Similarly로 지주 위반과 제재.",
    "turns": [
      8
    ],
    "id": "sequence-07",
  ...
  },
  {
    ...
    "compare": [
      [
        "contagion causes following(S2–3)",
        "less contagion, more fear(S5–7)",
        "사례의 결과 vs 정보 조건",
        "첫 장면은 경보 행동의 전파다. 뒤 연구는 시야 제한으로 무리 상태를 공유 못하는 불안이다. 감정 전염이 항상 공포를 증가시킨다는 일반 법칙을 제시한 것은 아니다."
      ],
      [
        "all other birds",
        "nearest neighbor",
        "원형의 전체 시야 vs 일렬의 국소 시야",
        "일렬에서 감정 전염이 절대 전혀 없다는 말은 except가 막는다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        5,
        "주어 The birds in a line → were less coordinated / were more nervous. who절은 볼 수 있는 범위, changing은 긴장의 행동 징후, where절은 원형 배치의 조건을 설명한다."
      ]
    ],
    "central": "새들이 서로 볼 수 있는 배치는 경계 행동의 협응과 감정 공유에 영향을 주며 시야가 제한되면 긴장이 커질 수 있다.",
    "tip": "A의 were more fearful는 C의 more nervous를 설명한다. 관찰 결과가 먼저 있고 연구자의 가설은 그 뒤다.",
    "topicEN": "Visual access to flockmates, coordination, and emotional contagion",
    "titleEN": "Seeing the Flock Changes How Birds Feel",
    "order": [
      [
        4,
        4,
    ...
    "insert": [
      6,
      "S5의 일렬 새가 더 긴장한다는 관찰 뒤에 왜 그런지 추정하는 Marc의 가설이 온다."
    ],
    "blank": [
      7,
      "except with their nearest neighbors",
      "전염의 완전 부재가 아니라 범위 제한임을 나타낸다."
    ],
    "vocab": [
      [
        "contagion",
    ...
    "answer": "③ B → C → A. 연구 소개(B)→배치별 관찰 결과(C)→긴장 차이를 정보 부족으로 설명하는 가설(A).",
    "turns": [
      5,
      6
    ],
