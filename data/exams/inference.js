...
window.EXAM_DATA["inference"] = [
  {
    ...
    "flow": [
      ...
      [
        ...
        3,
        3,
        "새로움은 원격성 자체보다 규모·단위의 변화다."
      ],
      [
        "소기업의 고용 전환",
        4,
        6,
        "구체적 사례와 낮은 전환 비용을 보여준다."
      ],
      [
        "물질적 흔적 부재",
        7,
    ...
    "compare": [
      [
        "1990s outsourcing",
        "cloudwork",
        "대기업·사업장 단위 vs 소기업·업무 단위",
        "둘 다 원격 노동이다. 과거에는 전혀 불가능했다는 식의 차이가 아니다."
      ]
    ],
    "refs": [
      [
      ...
      [
        7,
        "this way",
        "S5–6의 현지 시설 없이 디지털 수단으로 고용망을 바꾸는 방식"
      ],
      [
        7,
        "it",
    ...
    "syntax": [
      [
        3,
        "While절 주어 outsourcing → allowed companies to take advantage…. 주절 주어 cloudwork → changes → the volume and granularity. at which는 변화가 일어나는 업무 단위·규모를 연결한다."
      ]
    ],
    "central": "디지털 플랫폼은 업무를 작은 단위로 원격 거래하게 해 노동의 장소적 유연성을 높인다.",
    "tip": "고용 절차가 단순하다는 것은 근거이고, 그 결과인 장소에 덜 묶인다는 점이 밑줄의 뜻이다.",
    "topicEN": "Increased spatial flexibility of work through digital platforms",
    "titleEN": "Work That No Longer Sticks to a Place",
    "order": [
      [
        1,
        2,
    ...
    "insert": [
      3,
      "S2의 장소 분리 뒤에 과거·현재를 대비하고 S4가 cloudwork를 구체화한다."
    ],
    "blank": [
      2,
      "ties between service work and particular places can be disconnected",
      "less sticky의 비유를 직접 바꿔 쓴 문장이다."
    ],
    "vocab": [
      [
        "sticky",
    ...
    "answer": "②. 사업 수행의 공간적 유연성 증가. ① 모든 입지 딜레마 해결은 과장, ③ 확장 약화는 반대, ④ 법 자체 완화는 주체 변경, ⑤ 채용 단순화는 일부 수단만 고른다.",
    "turns": [
      3
    ],
    "id": "inference-01",
  ...
  },
  {
    ...
    "flow": [
      ...
      [
        ...
        7,
        7,
        "물리적 차이와 지각 유사성의 공존을 보여준다."
      ],
      [
        "두 차원 통합",
        8,
        8,
        "주파수 상승과 음 이름의 회귀를 함께 정리한다."
      ]
    ],
    "connectors": [
      [
    ...
    "compare": [
      [
        ...
        "come back home",
        "물리적 주파수 vs 지각적 음 이름",
        "S8의 주파수는 상승하고 음 이름은 반복된다. 돌아왔다는 말이 동일 주파수로 복귀했다는 뜻은 아니다."
      ]
    ],
    "refs": [
      [
      ...
      [
        6,
        "This phenomenon",
        "주파수가 달라도 옥타브 관계에서 유사하게 들리는 현상"
      ],
      [
        8,
        "one / another",
        "two dimensions의 각각 한 차원"
      ]
    ],
    "syntax": [
      [
        8,
        "music is described as having two dimensions → one that accounts for… / another that accounts for…. 병렬된 두 관계절이 서로 다른 차원을 설명한다."
      ]
    ],
    "central": "옥타브에서는 주파수와 높이가 달라져도 지각적으로 같은 음 이름에 돌아온 듯한 순환성을 느낀다.",
    "tip": "음 이름·지각적 유사성과 진동수·절대 높이를 분리해야 ②의 identical frequency 함정을 피한다.",
    "topicEN": "Physical and perceptual dimensions of octave repetition",
    "titleEN": "An Octave Higher, Yet Back Home",
    "order": [
      [
        1,
        4,
    ...
    "insert": [
      4,
      "This relationship이 S3의 두 배·절반을 받으며 S5의 It에 octave를 제공한다."
    ],
    "blank": [
      8,
      "two dimensions",
      "앞의 물리적 차이와 지각적 유사성을 함께 포괄한다."
    ],
    "vocab": [
      [
        "frequency",
    ...
    "answer": "③. 이름은 같지만 높이가 다른 음에 도달한다. ②는 같은 이름을 같은 주파수로 바꾼 오류. ① 옥타브 내부 구별, ④ 감수성 회복, ⑤ 패턴 구성은 밑줄의 회귀 의미가 아니다.",
    "turns": [
      7,
      8
    ],
  ...
  },
  {
    ...
    "compare": [
      [
        "felt weak(S7)",
        "strong performance(S7)",
        "상대 평가 vs 객관 수행",
        "평가 기준이 다르다. 상대가 더 잘했다고 자기 수행까지 나쁜 것은 아니다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        1,
        "주어 Basing your self-worth on climbing performance → 동사 puts → 목적어 you → 수식어 at the whim of external factors. 동명사구 전체가 주어다."
      ]
    ],
    "central": "외부 조건과 비교에 좌우된 성과를 자신의 가치나 능력 향상의 증거로 삼는 것은 믿기 어렵다.",
    "tip": "등반 기록이 거짓이라는 말이 아니라 그 기록을 자기 공로로 해석해 얻는 자존감의 근거가 불확실하다는 말이다.",
    "topicEN": "Unreliability of self-worth based on externally influenced performance",
    "titleEN": "When a Performance Boost Is an Illusion",
    "order": [
      [
        1,
        3,
    ...
    "insert": [
      8,
      "동료의 두 상태를 모두 검토한 뒤 환경이라는 새 외부 요인으로 넘어간다."
    ],
    "blank": [
      10,
      "something you can take credit for",
      "모든 사례에서 실제 자기 실력이 아닌 요인이 성과 평가를 만든다."
    ],
    "vocab": [
      [
        "at the whim of",
    ...
    "answer": "③. 성취에 대한 자부심의 근거가 믿을 만하지 않다. ②는 외부 조건을 꾸준한 노력으로 바꾸고, ④는 의욕 저하라는 일부 부정 사례에만 범위를 좁힌다.",
    "turns": [
      5,
      10
    ],
  ...
  },
  {
    ...
    "compare": [
      [
        "manual skill without scholarship",
        "only theories and scholarship",
        "결핍의 방향",
        "앞쪽은 이론이 없는 실기, 뒤쪽은 실기가 없는 이론이다. 한쪽을 칭찬하고 다른 쪽만 비판하는 구조가 아니다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        4,
        "주어 All of this study → 동사 was → 보어 necessary. he argued는 삽입구. because절 안에서 architects who…와 those who…가 while로 대조된다."
      ]
    ],
    "central": "건축가에게는 실제 구현 능력과 폭넓은 이론 지식이 함께 필요하다.",
    "tip": "밑줄은 이론이 무가치하다는 뜻이 아니라 실기 없는 이론 추구의 한계다.",
    "topicEN": "The need for both practical skills and theoretical knowledge in architecture",
    "titleEN": "Architecture Needs Both Knowledge and Practice",
    "order": [
      [
        1,
        2,
    ...
    "insert": [
      3,
      "S2에서 소개한 Vitruvius의 관점을 확장하고 S4의 this study가 받을 교육 목록을 제공한다."
    ],
    "blank": [
      3,
      "both practical and theoretical knowledge",
      "S4의 두 결핍을 모두 해결하는 조합이다."
    ],
    "vocab": [
      [
        "scholarship",
    ...
    "answer": "③. 실기 없이 건축의 이상을 추구함. ①은 실기 결핍을 누락, ② 학문 경시는 반대편 사례, ④ 물질 우선과 ⑤ 시대 기준은 원문의 대립 축이 아니다.",
    "turns": [
      4
    ],
    "id": "inference-04",
  ...
  },
  {
    ...
    "flow": [
      ...
      [
        ...
        5,
        5,
        "예외적 방문과 지속적 참여를 구분한다."
      ],
      [
        "거리 둔 관찰",
        6,
        6,
        "원칙과 실제의 간극을 비유로 정리한다."
      ]
    ],
    "connectors": [
      [
    ...
    "compare": [
      [
        "spent weeks to months there",
        "did not spend significant time with local people",
        "지역 체류 시간 vs 사람과의 교류 시간",
        "주어는 같지만 시간의 대상이 다르다. 현장에 오래 머물렀다고 주민과 오래 교류한 것은 아니다."
      ],
      [
        "should observe(S2)",
        "observed from verandas(S6)",
        "규범 vs 실제",
        "일부가 제안한 원칙과 초기 연구의 실제 한계를 대비한다."
      ]
    ],
    "refs": [
      [
    ...
    "syntax": [
      [
        5,
        "Although절에 did venture(강조) → 주절 did not spend. at times와 generally가 빈도 차이를 드러낸다."
      ]
    ],
    "central": "초기 민족지학자들은 현장을 방문했지만 현지인과의 충분한 직접 교류 없이 거리를 두고 관찰했다.",
    "tip": "현장에 있었는가와 현지인과 충분히 교류했는가는 다른 질문이다.",
    "topicEN": "Limited direct engagement in early ethnographic fieldwork",
    "titleEN": "In the Field, Yet on the Veranda",
    "order": [
      [
        1,
        2,
    ...
    "insert": [
      5,
      "중개자 의존을 설명한 뒤 방문 예외를 인정하고 Thus의 결론으로 이어진다."
    ],
    "blank": [
      6,
      "from their verandas",
      "장소를 문자 그대로만 읽지 말고 현지인과의 거리라는 함축을 잡는다."
    ],
    "vocab": [
      [
        "in question",
    ...
    "answer": "③. 연구 대상과의 직접 접촉이 적었음. ① 지속적 관계는 반대, ② 자연과학자 협업은 배경을 목적화, ④ 서양인 협력은 수단, ⑤ 넓은 시야는 관찰의 한계를 바꾼다.",
    "turns": [
      5,
      6
    ],
  ...
  },
  {
    ...
    "compare": [
      [
        ...
        "부분적 경험 vs 완전 소진",
        "S6의 앞은 정도가 있는 넓은 범주, 뒤는 완전 소진이라는 끝점이다. 같은 정의로 긍정·부정을 동시에 주장하지 않는다."
      ]
    ],
    "refs": [
      [
        4,
        "there",
        "전구에 경계가 있다는 존재 구문. 특정 장소 지시가 아니다."
      ],
      [
        5,
        "this problem",
        "지쳤지만 일을 하는 사람을 분류하지 못하는 S4의 문제"
      ],
      [
        5,
        "it",
      ...
      [
        6,
        "They",
        "부분적·덜 심한 번아웃을 겪는 사람들"
      ]
    ],
    "syntax": [
      [
        4,
        "If절은 이분법 가정 → 주절 we have no good way → to categorize people → who절이 people 수식. but은 who절 안에서 보고와 기능을 대조한다."
      ]
    ],
    "central": "번아웃은 유무의 이분법이 아니라 기능을 유지하는 부분적 소진까지 포함하는 연속선으로 보아야 한다.",
    "tip": "hasn’t had the last word는 논쟁이 안 끝났다는 말이 아니라 아직 소진의 극단에 이르지 않았다는 뜻이다.",
    "topicEN": "Burnout as a spectrum of severity rather than an all-or-nothing state",
    "titleEN": "Burnout Has Degrees",
    "order": [
      [
        1,
        1,
    ...
    "insert": [
      5,
      "this problem이 S4의 분류 문제를 받고 S6의 They가 부분적 소진 집단을 받는다."
    ],
    "blank": [
      1,
      "a spectrum",
      "일을 못할 정도와 일을 할 수 있는 상태를 모두 설명해야 한다."
    ],
    "vocab": [
      [
        "breadth",
    ...
    "answer": "②. 더 높은 소진 정도에 이를 여지가 있다. ①은 상태를 논의 종료로 바꾸고 ③은 연속선과 반대, ④는 회복 방법, ⑤는 개인 인식의 원인론을 덧붙인다.",
    "turns": [
      1,
      4
    ],
  ...
  },
  {
    ...
    "flow": [
      ...
      [
        ...
        7,
        8,
        "경험은 유지하되 스트레스 고착을 줄이는 비유다."
      ]
    ],
    "connectors": [
      [
        2,
        "even though / because / for",
        "주의가 흩어짐",
        "스트레스 요소만 보는 좁은 범위라는 이유"
      ],
      [
        5,
        "but",
    ...
    "compare": [
      [
        ...
        "narrowly focused",
        "주의의 이동 방식 vs 내용 범위",
        "여러 부정적 세부 사이를 오가도 부정적 내용만 보면 범위는 좁다."
      ],
      [
        "still fry an egg",
        "egg won’t stick",
        "사건 경험 vs 심리적 고착",
        "스트레스 사건이 없어지는 것이 아니라 반응이 달라진다."
      ]
    ],
    "refs": [
      [
      ...
      [
        7,
        "It",
        "S3–6의 관점을 넓혀 스트레스에 고착되지 않는 변화 전체"
      ],
      [
        8,
        "the egg / the pan",
        "비유에서 스트레스 경험 / 그것을 받아들이는 자신"
      ]
    ],
    "syntax": [
      [
        1,
        "주어 How you focus your attention(명사절) → 동사 plays → 목적어 a critical role. in how you deal…는 역할이 작용하는 영역이다."
      ]
    ],
    "central": "스트레스 요소에만 매달리지 않고 경험 전체로 주의 범위를 넓히면 스트레스를 놓아주기 쉬워진다.",
    "tip": "산만함은 이동 방식, 넓은 시야는 포함하는 내용의 범위다. 둘을 같은 뜻으로 읽으면 S2가 모순처럼 보인다.",
    "topicEN": "Reducing stress by broadening attentional perspective",
    "titleEN": "A Wider View Makes Stress Less Sticky",
    "order": [
      [
        1,
        2,
    ...
    "insert": [
      3,
      "S2의 좁은 주의가 먼저 나온 뒤 widened의 대조가 자연스럽다."
    ],
    "blank": [
      4,
      "many more aspects",
      "스트레스 요소 밖의 여러 측면을 포함해야 전체 관점이 된다."
    ],
    "vocab": [
      [
        "scattered",
    ...
    "answer": "④. 스트레스 측면을 넘어 경험을 넓게 보는 것. ①은 스트레스 자체의 제거로 과장, ②는 원인 규명으로 목적 변경, ③ 긍정에 한정하지 않는다는 말은 초점 이탈, ⑤는 인과 역전이다.",
    "turns": [
      5,
      8
    ],
  ...
  },
  {
    ...
    "flow": [
      ...
      [
        ...
        5,
        7,
        "경제 전체를 대안 조건으로 복제할 수 없음을 설명한다."
      ],
      [
        "생각하는 행위자의 복잡성",
        8,
        9,
        "통제하기 어려운 근본 이유를 보강한다."
      ]
    ],
    "connectors": [
      [
    ...
    "compare": [
      [
        "study different economies",
        "economy-wide controlled experiments",
        "관찰·비교 vs 조건 통제",
        "나라가 다르면 여러 조건도 함께 달라진다. 비교 가능하다고 같은 경제의 실험 조건을 통제할 수 있는 것은 아니다."
      ]
    ],
    "refs": [
      [
      ...
      [
        ...
        "스스로 판단하는 경제 행위자를 물리학 입자에 빗댄 가정"
      ]
    ],
    "syntax": [
      [
        9,
        "Think → 목적어 how hard physics would be → 조건 if particles could think. 반사실적 가정으로 연구 대상의 차이를 강조한다."
      ]
    ],
    "central": "개별적으로 판단하는 수많은 행위자로 구성된 경제 전체는 자연과학처럼 통제 실험하기 어렵다.",
    "tip": "모든 경제 연구가 불가능하다는 말이 아니라 경제 전체의 조건 통제·복제가 어렵다는 범위 제한이다.",
    "topicEN": "Limits on controlled experimentation in macroeconomics",
    "titleEN": "Why an Economy Cannot Fit into a Test Tube",
    "order": [
      [
        1,
        3,
    ...
    "insert": [
      5,
      "실험 기회의 차이를 설명한 뒤 one patient로 제약을 구체화하고 시험관 비유로 요약한다."
    ],
    "blank": [
      6,
      "squeeze economies into a test tube",
      "실험 통제의 한계를 표현하며 복잡한 이론 사용이나 자료 수집을 뜻하지 않는다."
    ],
    "vocab": [
      [
    ...
    "answer": "②. 경제에 대한 통제 실험 실시. 문장의 can’t와 결합해 불가능성을 나타낸다. 나머지는 기여 인정·이론 사용·결과 공유·장기 자료 수집으로 뜻을 바꾼다.",
    "turns": [
      2,
      3
    ],
